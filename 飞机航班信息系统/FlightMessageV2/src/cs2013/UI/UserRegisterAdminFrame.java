...
public class UserRegisterAdminFrame extends JFrame {
	...
	private static Logger logger = Logger.getLogger(UserRegisterAdminFrame.class);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserRegisterAdminFrame frame = new UserRegisterAdminFrame();
	...
	public UserRegisterAdminFrame() {
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				sb.append("\t权限:" + comboBox.getSelectedItem().toString());
				sb.append("\n");
		...
		passwordField.setBounds(225, 113, 156, 21);
		...
		passwordField_1.setBounds(225, 161, 156, 21);
		...
		JLabel label = new JLabel("\u6743  \u9650\uFF1A");
		label.setFont(new Font("宋体", Font.PLAIN, 17));
		label.setBounds(102, 197, 79, 28);
		contentPane.add(label);

		comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {
				"\u7BA1\u7406\u5458", "\u666E\u901A\u7528\u6237" }));
		comboBox.setBounds(225, 202, 156, 21);
	...
	public void userRegister() {
		...
		if (service.register(user)) {
			logger.info(user.getUser_id() + "join us,(Admin)");
